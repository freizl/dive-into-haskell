...
getSubWeiboR :: Yesod master => GHandler HelloSub master RepHtml
getSubWeiboR = defaultLayout [$hamlet|Welcome to the subsite weibo page!|]
...
<p>
    ...
    \ as well.
    <a href=@{SubsiteR SubWeiboR}>weibo
|]
